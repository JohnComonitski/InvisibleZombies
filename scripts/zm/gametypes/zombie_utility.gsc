...
function ai_calculate_health( round_number )
{
	...
	for ( i=2; i <= round_number; i++ )
	{
		...
		if ( i >= 10 )
		{
			...
			{
				//we must have overflowed the signed integer space, just use the last good health, it'll give some headroom to the 
				//capped value to account for extra damage applications
